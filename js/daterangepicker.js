        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu">' +
                ...
                '<div class="ranges">' +
                  '<div class="range_inputs">' +
                    ...
                    '</div>' +
                    '<button class="btn btn-small btn-success applyBtn" disabled="disabled" style="margin-top: 5px">' + this.locale.applyLabel + '</button>&nbsp;' +
                    '<button class="btn btn-small clearBtn pull-right" style="margin-top: 5px">' + this.locale.clearLabel + '</button>' +
                  '</div>' +
                '</div>' +
              '</div>';
