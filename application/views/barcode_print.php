			...
			<table class="table table-condensed table-striped">
				...
				<tbody>
			 		<tr id="1" style="display: none;">
						...
						<td><input type="text" readonly="true" class="Numeric input-mini span12" name="new_quantity[]" value="" 					</t					<td class="aligncenter"><span id="1"><a href="#" class="btn btn-danger btn-mini"><i class="icon-minus icon-white"></i></a></span></td>
					</tr>
					<tr id="Blank">
