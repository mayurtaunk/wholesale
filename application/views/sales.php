				...
				<table class="table table-condensed table-striped">
					...
					<tbody>
							...
							<tr>
								...
								<td colspan=2><input type="text" class="Numeric span12" name="disnote" value="<?php echo $disnote?>" placeholder="Notes" /></td>
								<td colspan=2><input type="text" class="Numeric span5" name="discount" value="<?php echo $discount?>" placeholder="Discount" /></td>
							...
							<tr>
								...
								<td></td>
								<td></td>
								<td colspan=2><input type="text" readonly class="Numeric span5" name="topay" value="<?php echo $topay?>" placeholder="To Pay" /></td>
							<tr>
							<tr>
								<td></td>
								<td></td>
								...
								<td></td>
								<td></td>
								<td colspan=2><input type="text" class="Numeric span5" name="paid" value="<?php echo set_value('paid', $row['amount_recieved']) ?>" placeholder="Paid" /></td>
							<tr>
					</tbody>
				</table>
			</fieldset>
