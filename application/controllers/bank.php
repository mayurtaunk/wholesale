...
class Bank extends CI_Controller {
	...
	public function index() {
		...
		$config['base_url'] = base_url().'index.php/bank/index/';
		$config['total_rows'] = $this->db->count_all('bank_details');
		$config['per_page'] = 7;
		$config['num_links']=20;
		...
		$query = $this->db->get('bank_details', $config['per_page'],$this->uri->segment(3));
	...
	public function edit($id) {
		...
		$query = $this->db->query("SELECT id,name, account_no, bankname,state,branch,mobileno,balance FROM bank_details WHERE id = $id");
